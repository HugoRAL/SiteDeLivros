...
<body class="p-3 mb-2 bg-dark text-white">  
  ...
  <div>
    <div>
      <h1 style="text-align: center;">The Begging Atfer The End</h1>
      <div style="display: flex;margin: 5%;">
        <img src="../Assets/Img/The Begging Atfer The End.jpg" style="max-width: 20%;">
  ...
  <div class="btn-group-vertical;" style="margin: 5%;width: 90%;">
    ...
    <?php 
    $name = "The Begging Atfer The End";
